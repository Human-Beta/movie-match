...
| Animation       | **CSS transitions**        | Simple, feature-scoped result emphasis; fullscreen shared-layout work is deferred            |
...
- Keep current result presentation to CSS transitions. Do not add an animation runtime until task 029 has a validated fullscreen shared-layout prototype with stable geometry and scroll behavior.
