...
| Animation       | **CSS animations**         | Simple, feature-scoped result emphasis without a client animation runtime                    |
...
- Keep current result presentation to feature-scoped CSS animations. Do not add an animation runtime without a concrete product requirement and validated layout behavior.
